...
var post_box = new L.OverPassLayer({
	...
	callback: function(data) {
		for(var i=0;i<data.elements.length;i++) {
			...
			if (e.tags.collection_times) {popup = popup + '<div class="row_pp"><div class="cell"><b>Leerungszeiten:</b></div><div class="cell">' + e.tags.collection_times.replace("Su", "So") + '</div></div>'};
